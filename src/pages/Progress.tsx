  ...
  useEffect(() => {
    ...
    sessions.forEach((session) => {
      ...
      session.exercises.forEach((ex) => {
        const match =
          chartView === "exercise"
            ? ex.exercise === selectedItem
            : ex.muscleGroup === selectedItem;
        if (match) {
    ...
    <Layout>
      <div className="space-y-8 px-4 py-6">
        ...
        <div className="flex justify-center">
          ...
          >
            <option value="">
              Select {chartView === "exercise" ? "Exercise" : "Muscle Group"}
            </option>
            {options.map((item) => (
        ...
        {chartData ? (
          ...
          <div className="bg-white border border-gray-200 rounded shadow p-4 w-full">
            <p className="text-center text-gray-500">
              Select an item to view progress.
            </p>
          </div>
        )}
      </div>
